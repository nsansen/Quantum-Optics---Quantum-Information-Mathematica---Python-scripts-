...
global spre_a spost_a spre_ad spost_ad spre_ada spost_ada spre_a_spost_ad spre_spsm spost_spsm spre_adsm spost_adsm spre_asp spost_asp spre_photon_hopping spost_photon_hopping spre_trans_photon_hopping spost_trans_photon_hopping
...
A = 0.1;      % Inter-cavity hopping rate
...
Omega = 0.2;   % Cavity driving strength
...
[spre_a, spost_a, spre_ad, spost_ad, spre_ada, spost_ada, spre_a_spost_ad, spre_spsm, spost_spsm, spre_adsm, spost_adsm, spre_asp, spost_asp, spre_photon_hopping, spost_photon_hopping, spre_trans_photon_hopping, spost_trans_photon_hopping] = build_shrunken_system_operators(M_shrink, add_matrix, M_shrink_perm, M, n_max);
...
for loop_var = 1:length(var_list)
    ...
    % Find how to drive the lowest-lying two particle mode:
    delta_omega_d = return_driving_laser_detuning_lowest_two_particle_resonance(g, delta, J);
    delta_omega_0 = delta_omega_d - delta;
    
    L_shrink = build_flattened_liouvillian_in_reduced_space(delta_omega_d, delta_omega_0, g, A, Omega, gamma_p, M, n_max);

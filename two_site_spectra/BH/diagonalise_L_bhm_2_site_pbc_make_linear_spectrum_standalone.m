function diagonalise_L_bhm_2_site_pbc_make_linear_spectrum_standalone(job_number)
% Script to build the flattened Liovillian and the diagonalise it:
% clear

if ischar(job_number), job_number = str2num(job_number); end;

save_prefix = 'BH_ED_linear_spectrum_OBC_';
...
delta_omega_d_list = linspace(-3,3,51);

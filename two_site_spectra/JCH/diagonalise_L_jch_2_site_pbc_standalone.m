function [num_t_store, numsq_t_store, t] = nikos_time_evolve_2_sites(job_number)
...
save_prefix = 'two_site_spectrum_BH_increasing_J_';
save_name = [save_prefix num2str(job_number) '.mat'];

% Parameters:

n_max = 4  % Photon truncation parameter
...
y00_L = b_dag*b_dag*b_dag*b_dag*sigma_m*y00_blank;
...
% save(save_name, 'n_max', 'M', 'delta_omega_d_list', 'gamma_p', 'gamma_a', 'Omega', 'J', 'g', 'rho_store')
